...
"C:\Program Files\7-Zip\7z" a -xr!.svn smartTemplateWeb.zip manifest.json chrome locale popup skin st-background.js license.txt icon.png release-notes.html
