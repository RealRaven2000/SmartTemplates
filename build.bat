...
move smartTemplate-*.xpi "..\..\..\Test Versions\4.11\"
powershell -Command "Start-Sleep -m 400"
rename smartTemplateWeb.zip smartTemplate-fx-4.11pre%smartTemplateRev%.xpi