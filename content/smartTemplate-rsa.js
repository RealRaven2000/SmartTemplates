...
SmartTemplate4.RSA = {
  initialise: function initialise(maxDigits) {
    SmartTemplate4.RSA.BigIntModule.reset();
    SmartTemplate4.RSA.BigIntModule.init(maxDigits);
  } ,
  
  log: function log(txt) {
    SmartTemplate4.Util.logDebugOptional('premium.rsa', txt);
  },
  ...
  BigIntModule : {
    ...
    init: function init(MaxDigits) {
      ...
      SmartTemplate4.RSA.log('BigInt.init(' + MaxDigits + ')');
    ...
    biCopy: function biCopy(bi) {
      SmartTemplate4.RSA.log('BigInt.biCopy()');
  ...
  Barrett : {
    ...
    BarrettMu: function BarrettMu(m) {
      let RSA = SmartTemplate4.RSA,
          ...
          barret = SmartTemplate4.RSA.Barrett;
    ...
    BarrettMu_multiplyMod: function BarrettMu_multiplyMod(x, y) {
      let BInt = SmartTemplate4.RSA.BigIntModule,
    ...
    BarrettMu_powMod: function BarrettMu_powMod(x, y) {
      let BInt = SmartTemplate4.RSA.BigIntModule,
          isLog = SmartTemplate4.Preferences.isDebugOption('premium.rsa');
