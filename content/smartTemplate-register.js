...
(function() {
  ...
  showDialog: function showDialog(featureName) {
		...
		util.Mail3PaneWindow.openDialog('chrome://SmartTemplate4/content/register.xul','smarttemplate4-register','chrome,titlebar,centerscreen,resizable,alwaysRaised,instantApply',SmartTemplate4,params).focus();
  } ,
